<?php
	...
	if ($_POST["attribute"] == "ID") {
		...
		$sql = "DELETE FROM Resource_Table WHERE Resource_ID = '$ID'";
	}
	elseif ($_POST["attribute"] == "creatorID"){
		...
		$sql = "DELETE FROM Resource_Table WHERE Creator_ID = '$creatorID'";
	}
	elseif ($_POST["attribute"] == "title"){
		...
		$sql = "DELETE FROM Resource_Table WHERE Title = '$title'";
		}
	elseif ($_POST["attribute"] == "restID"){
		...
		$sql = "DELETE FROM Resource_Table WHERE Resource_Type_ID = '$restID'";
		}
//--------------------------------------------------------------------------------------------------------------	
